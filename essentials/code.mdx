...
Once your ticket has been addressed, a team member from Shuttle Services will provide you with a unique license key. Please **SAVE** this key, as if you get termed, you can redeem on a new account.
...
```
Make sure to enter the **FULL** kep including SHUTTLE_
...
3. Enter the license key you received from the Shuttle Services `/panel` command.
